...
import { Box, Typography, Button, InputAdornment, Tooltip, Menu, Checkbox, Divider, LinearProgress } from '@mui/material';
...
export function SharedFilesListing() {
  ...
  const getSharedRootFiles = () => {
    if (selectedUser) {
      ...
      GalleryService
        .getSharedContent(accID, subscriberId, subscriptionId, schemaId)
        .then(res => {
...
export default compose(withConnect)(SharedFilesListing);
