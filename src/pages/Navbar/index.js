...
import {
    setAgentApiTokenState, setAnalyticsAppsState, setAnalyticsDataSetsState, setAnalyticsDataSourcesState,
    setAnalyticsFilesState, setCostUsageState, setExtractionDocumentTypesState, setExtractionFilesState, setExtractionIntegrationsState, setExtractionTasksState,
    setExtractionTriggersState, setProjectAccessState, setProjectsState, setRoleInstanceState,
    setSpacesState, setStripeTransactionsState, setWorkspaceAccessState
...
function Navbar() {
    ...
    useEffect(() => {
        dispatch(setAnalyticsAppsState([]))
        dispatch(setAnalyticsFilesState([]))
        dispatch(setAgentApiTokenState([]))
        dispatch(setExtractionTasksState([]))
        dispatch(setExtractionFilesState([]))
        dispatch(setAnalyticsDataSourcesState([]))
        dispatch(setAnalyticsDataSetsState([]))
        dispatch(setExtractionIntegrationsState([]))
        dispatch(setExtractionTriggersState([]))
        dispatch(setExtractionDocumentTypesState([]))
        //eslint-disable-next-line
