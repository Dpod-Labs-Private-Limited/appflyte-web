/*
 * CollectionTypeAddRichText Messages
 *
 * This contains all the text for the CollectionTypeAddRichText component.
 */

import { defineMessages } from 'react-intl';

export const scope = 'app.components.CollectionTypeAddRichText';

export default defineMessages({
  heading: {
    id: `${scope}.heading`,
    defaultMessage: 'ADD NEW RICH TEXT FIELD',
  },
  cancelBtn: {
    id: `${scope}.cancelBtn`,
