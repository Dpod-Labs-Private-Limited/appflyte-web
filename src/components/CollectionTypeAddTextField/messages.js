/*
 * CollectionTypeAddTextField Messages
 *
 * This contains all the text for the CollectionTypeAddTextField component.
 */

import { defineMessages } from 'react-intl';

export const scope = 'app.components.CollectionTypeAddTextField';
