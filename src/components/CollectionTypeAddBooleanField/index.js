...
function CollectionTypeAddBooleanField(props) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      defValue: editdata?.fieldData?.field_settings?.default_value ?? 'Null',
    },
    validate,
...
CollectionTypeAddBooleanField.propTypes = {
...
export default CollectionTypeAddBooleanField;
