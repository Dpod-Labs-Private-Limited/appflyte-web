/*
 * CollectionTypeAddPasswordField Messages
 *
 * This contains all the text for the CollectionTypeAddPasswordField component.
 */

import { defineMessages } from 'react-intl';

export const scope = 'app.components.CollectionTypeAddPasswordField';

export default defineMessages({
  heading: {
    id: `${scope}.heading`,
    defaultMessage: 'ADD NEW PASSWORD FIELD',
  },
  cancelBtn: {
    id: `${scope}.cancelBtn`,
