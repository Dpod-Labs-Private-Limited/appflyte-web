...
function CollectionTypeAddDateField(props) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      subType: editdata?.fieldData?.field_sub_type ?? 'dateTime',
      dateFormat: editdata?.fieldData?.field_settings?.date_format ?? '',
        ...
        <Box display="flex" flexWrap="wrap" width="100%" overflow="auto" px="15px" py="15px">
          ...
          >
            <Box width="100%">
              ...
              <TextField
                variant="filled"
                label={<FormattedMessage {...messages.subType} />}
                margin="normal"
                error={formik.errors.subType && formik.touched.subType}
            ...
            <Box width="100%">
              ...
              >
                <MenuItem key={1} value={"current"}>
                  {"Current " + formik.values.dateFormat}
                </MenuItem>
              </TextField>
...
CollectionTypeAddDateField.propTypes = {
...
export default CollectionTypeAddDateField;
